...
namespace FBMCE.Amazon
{
    public class SignedRequestHelper
    {
        ...
        private const string FBMCE_URL = "http://www.xyz.net/FBMCE/amazonsign.php?url=";
         ...
         *  CA: ecs.amazonaws.ca
         */
        public SignedRequestHelper(string awsAccessKeyId, string destination)
        {
        ...
        public string Sign(IDictionary<string, string> request)
        {
            ...
            WebRequest req = HttpWebRequest.Create(FBMCE_URL + HttpUtility.UrlEncode(builder.ToString()));
