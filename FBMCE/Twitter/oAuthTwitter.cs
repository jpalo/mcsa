    ...
    public class oAuthTwitter : OAuthBase
    {
        ...
        public string ConsumerKey
        {
            get
            {
                ...
                {
                    _consumerKey = Resources.Twitter_ConsumerKey;
                }
                return _consumerKey;
            }
        ...
        public string ConsumerSecret
        {
            get
            {
                ...
                {
                    _consumerSecret = Resources.Twitter_ConsumerSecret;
                }
        ...
        {
            this.xAuthUsername = UrlEncodeForOAuth(username);
            this.xAuthPassword = UrlEncodeForOAuth(password);
        ...
        public string oAuthWebRequest(Method method, string url, string postData)
        {
            ...
            querystring += "&oauth_signature=" + UrlEncodeForOAuth(sig);
        ...
        public string WebRequest(Method method, string url, string postData)
        {
            ...
            webRequest.UserAgent = Resources.Twitter_Client;
            webRequest.Timeout = 30000;

            try
            {
                webRequest.Headers.Add("X-Twitter-Client", Resources.Twitter_Client);
                webRequest.Headers.Add("X-Twitter-Client-URL", Resources.Twitter_ClientUrl);
                ...
                if (string.IsNullOrEmpty(_assemblyVersion))
                {
                    ...
                    webRequest.Headers.Add("X-Twitter-Client-Version", _assemblyVersion);
                }
                else
                {
                    webRequest.Headers.Add("X-Twitter-Client-Version", _assemblyVersion);
